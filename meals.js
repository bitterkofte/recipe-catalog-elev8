var meals = [
  ...
  },
  {
    "id": "lamb-pilav",
    "type": "Meal",
    "title": "Turkish Lamb Pilav",
    "description": "Serve up a basmati rice one pot flavoured with cinnamon, mint and apricot, studded with tender lamb.",
    "image": "lamb-pilav.png",
    "stars": 4.8,
    "comments": [
      {
        "username": "Asım",
        "comment": "If I could give the slow cooker recipe zero, I would. Absolute slop, £15 of lamb went in the recycle bin. Take it down and never write another recipe."
      },
      {
        "username": "Yiğit",
        "comment": "My friends just loved it, thanks!"
      },
      {
        "username": "Batuhan",
        "comment": "I have cooked this twice and have been really disappointed with the lack of depth of flavour of the aubergine dish Even added a bit of tomato puree to the ripe tomatoes second time around whilst cooking to try to bring out a bit more flavour."
  ...
  },
  {
    "id": "almond-pastries",
    "type": "Dessert",
    "title": "Almond & Honey Pastries with Orange Cream",
    "description": "Serve these prepare-ahead puds with coffee, dessert wine or fresh mint tea for a real after-dinner treat.",
    "image": "almond-pastries.png",
    "stars": 4.1,
    "comments": [
      {
        "username": "Mine",
  ...
  },
  {
    ...
    "description": "Make some burma-style baklava from Turkey with spiced nuts, ricotta and chocolate.",
    "image": "baklava.png",
    "stars": 4.8,
    "comments": [
      {
